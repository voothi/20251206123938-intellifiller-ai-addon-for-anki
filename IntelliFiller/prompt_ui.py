...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.promptNameInput = QtWidgets.QLineEdit(parent=self.widget)
        ...
        self.targetFieldInput = QtWidgets.QLineEdit(parent=self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.pinnedCheckbox = QtWidgets.QCheckBox(parent=self.widget)
        self.pinnedCheckbox.setText("Pin to Menu")
        self.pinnedCheckbox.setObjectName("pinnedCheckbox")
        self.verticalLayout_2.addWidget(self.pinnedCheckbox)
        ...
        self.removePromptButton = QtWidgets.QToolButton(parent=self.layoutWidget)
